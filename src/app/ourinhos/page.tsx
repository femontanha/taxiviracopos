...
export const metadata: Metadata = {
  title: 'Taxi Viracopos - Ourinhos | Taxi Viracopos | Taxi para executivos e viagens',
  description: 'Taxi para Ourinhos, viracopos para Ourinhos, Ourinhos para viracopos taxi, promoção',
  openGraph: {
    title: 'Taxi Viracopos - Ourinhos | Taxi Viracopos | Taxi para executivos e viagens',
    locale: 'pt_BR',
    type: 'article',
...
export default function Page() {
  return (
    <main className={styles.main}>
      <SectionIntroduction name="Ourinhos" />
      <SectionFocus />
      <SectionMoreInformation distance="356km / 4:30 hs" />
      <SectionContact />
    </main>
  );
}
